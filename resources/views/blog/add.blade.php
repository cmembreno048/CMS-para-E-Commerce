    ...
    <div class="col-md-9" style="padding-right: 0;">
        <div class="container-fluid">
            <div class="panel shadow">
                <div class="header">
                    <h2 class="title"><i class="fas fa-edit"></i> Crear publicación</h2>
                </div>
                <div class="inside container">
                    ...
                    @endif 
                        {!! Form::open(['url' => '/blog/add/a',  'enctype' => "multipart/form-data", 'class' => '']) !!}  
                            ...
                            <div class="row mtop16">
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        {!! Form::text('title' ,null, ['class' =>'form-control',  'aria-label'=>"Username", 'aria-describedby'=>"basic-addon1"]) !!}
                                    </div>
                                    @if ($errors->has('title'))
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="custom-file">
                                        {!! Form::file('img_publication', ['class' =>'custom-file-input', 'id'=>"blog_image", "accept"=>"image/*"]) !!}
                            ...
                            <div class="row mtop16">
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        {!! Form::text('video' ,null, ['class' =>'form-control',  'aria-label'=>"Username", 'aria-describedby'=>"basic-addon1"]) !!}
                                    </div>
                                    @if ($errors->has('video'))
                                    <div class="alert alert-danger mtop16">    
                            ...
                            <div class="row mtop16">
                                <div class="col-md-12">
                                    ...
                                    {!! Form::textarea('description' ,null, ['class' =>'form-control', 'id'=>'editor', 'aria-label'=>"Username", 'aria-describedby'=>"basic-addon1"]) !!}
                                </div>
    ...
    <div class="col-md-3" style="padding-left: 0;">
        <div class="container-fluid">
            <div class="panel shadow">
                ...
                <div class="inside container">
                    <img src="" class="mycenter" alt="imagen de publicación"  id="img_pbl" width="200">
                </div>
            </div>
        </div>
    </div>
